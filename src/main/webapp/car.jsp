...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    	<a class="nav-link active act-cust" href="car">Buy a Car</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
	  <div class="row">
	    <div class="col-md-3">
	      ...
	      <p>Filter By Price</p>
		    <form action="filterpricecar" method="POST">
		    ...
		    <form action="filterareacar" method="POST">
		    ...
		    <form action="filtercitycar" method="POST">
		    ...
		    <form action="filterstatecar" method="POST">
		    ...
		    <form action="filterzipcar" method="POST">
    ...
    <footer class="footer">
        ...
        <h1 id="nivi">Devloped by nivi</h1>
