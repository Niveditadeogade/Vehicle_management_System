...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    	<a class="nav-link active act-cust" href="bike">Buy a Bike</a>
                    </li>
                    <li class="nav-item">
		...
		<div class="row">
		    <div class="col-md-3">
		      <div class="filters-div">
				...
				<p>Filter By Price</p>
				<form action="filterpricebike" method="POST">
				...
				<form action="filterareabike" method="POST">
				...
				<form action="filtercitybike" method="POST">
				...
				<form action="filterstatebike" method="POST">
    ...
    <footer class="footer">
        ...
        <h1 id="nivi">Developed by nivi</h1>
