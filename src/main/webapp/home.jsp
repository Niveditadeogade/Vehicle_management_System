...
background: linear-gradient(to right, #87CEEB, #808080);
	    margin: 0 !important;
	    padding: 0 !important;
	}
...
<body>
	<div class="card">
        <div class="card-body">
            ...
            <h1 class="mov-head">Hub Of Vehicle</h1>
            ...
            <a href="login"><button type="button" class="btn btn-success">Login</button></a><br><br>
        </div>
      </div>
</body>
</html>