...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">HubOfVehicle</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link active act-cust" href="dashboard">Dashboard</a>
                    </li>
                    <li class="nav-item">
                    	<a class="nav-link active" href="car">Buy a Car</a>
                    </li>
                    <li class="nav-item">
                    	<a class="nav-link active" href="bike">Buy a Bike</a>
                    </li>
                    <li class="nav-item">
                    	<a class="nav-link active" href="sell.jsp">Sell your vehicle</a>
                    </li>
                    <li class="nav-item">
                ...
                <a href="logout"><Button class="btn btn-danger logout">Logout</Button></a><br /><br />
            </div>
        </div>
     </nav>
        ...
        <div class="col-md-4">
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <a href="car" class="btn go-btn">Cars</a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <a href="bike" class="btn go-btn">Bikes</a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <a href="sell" class="btn go-btn">Sell</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer class="footer">
        ...
        <h1 id="nivi">Developed Nivedita deogade</h1>
        <a href="https://www.facebook.com/profile.php?id=100081126168574"><i class="social-icon fab fa-facebook-f"></i></a>
